...
> 原文:[https://developers . red hat . com/blog/2018/03/12/3 scale-red-hat-integration-forge rock-using-OpenID-connect](https://developers.redhat.com/blog/2018/03/12/3scale-red-hat-integration-forgerock-using-openid-connect)
...
![](../Images/57bfd8957f048a51be515a90c60abfca.png)
...
![](../Images/c7ff1423025e1e25526f97bb0ea5c1f9.png)
...
![](../Images/b8dc19c42e5e563d2ce4a308ab2bd9b2.png)
...
![](../Images/01b8b1306e5b1095057f4798265a06bf.png)

3.点击`edit integration settings`:

![](../Images/1af66cd49493bc0e3b42ee707f4157f7.png)

4.选择`OpenID Connect`并点击`Update Service`:

![](../Images/b431cddc7f656149bbd2c6dfd7f270fd.png)

5.返回整合页面，点击`edit APIcast configuration`:

![](../Images/7e615a8e15552a76c6293f52635a1834.png)

6.输入`Staging and Production base URL`。我们将在 docker 上本地部署 APIcast 网关，因此将其命名为`http://localhost:8080`:

![](../Images/3d9c9b3537b4f849f441bbdcf228d9d3.png)
...
![](../Images/226eb6f2e6199bc0c4dd95595bf7ce66.png)

8.2 点击`Application`:

![](../Images/1681da152e0babcdeadac91340f408f1.png)

8.3 点击`Create Application`链接:

![](../Images/f32813da1e14f04b68ef680c0ef85c70.png)

8.4 选择服务的`Application Plan`，然后点击`Create Application`:

![](../Images/d3b0755df16daf531560c01f6d6b5e02.png)
...
![](../Images/917ed71356f6f2250b88dc3afcb4ba7d.png)
...
 ![](../Images/46fb718ffe13f08340bc359d9b0a75a2.png)

2.点击`Configure Oauth Provider` → `Configure OpenID Connect`:

 ![](../Images/6ac2c75b0c510f827371a6143e4babe5.png)

3.点击`Create`:

 ![](../Images/62888a359a21eafe4ea26ba731bedf66.png)
...
 ![](../Images/e1e7b649edbf800918a5345427eab71e.png)

5.创建将根据 IDP 进行身份验证的**最终用户**。

5.1 转到`Realms` → `Subjects.`点击**新建:**

 ![](../Images/1af7a228e54106baf4e76ae17fa37121.png)

5.2 输入“ID: apiUser”和“密码:12345678 ”:

 ![](../Images/60ebdab62a346c2d8c45909f432020f6.png)
...
![](../Images/95bbe979cee1370ef669323ca3c333d7.png)

点击**允许:**

![](../Images/8ce4a7ac7e4c9f70d607d8e4ba018479.png)

一个`access_token`和`id_token`被重定向回应用程序。`id_token`是由 IDP 生成的 JWT 令牌。

在 JWT.io 网站上粘贴令牌以解密内容(可选):

![](../Images/0360c3dc4634e83aab8cc36eb710440f.png)
