# 使用 PHP 和 Red Hat 容器开发工具包(CDK)构建您的第一个应用程序

> 原文：<https://developers.redhat.com/articles/build-your-first-application-using-php-red-hat-container-development-kit-cdk>
