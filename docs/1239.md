...
虽然从技术上来说，Linux 中没有表示容器的单一数据结构，但是内核名称空间和 [clone()](http://man7.org/linux/man-pages/man2/clone.2.html) 系统调用是最接近的。【T2![](../Images/625c19582c05c155960e60cc79426243.png)
